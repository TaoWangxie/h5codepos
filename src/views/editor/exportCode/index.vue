<template>
    <div>
        ...
        >   
            <div class="NavTabBox">
                <NavTab  :key:boolean="visible" class="NavTab" :tabIndex="tabIndex" :list='tabList' @tabClick="emitTabClick" />
            </div>
            <div class="container">
                <v-ace-editor
            ...
            <template #footer>
                <el-button type="success" :icon="DocumentCopy" circle @click="copyClick"  />
            </template>
        </el-dialog>
    </div>
</template>
...
import NavTab from "@/views/editor/navTab/index.vue";
import useClipboard from 'vue-clipboard3';
import { VAceEditor } from "vue3-ace-editor";
import 'ace-builds/src-noconflict/mode-json';
import 'ace-builds/src-noconflict/theme-chrome';
import ace from 'ace-builds';
import { SemiSelect, DocumentCopy } from '@element-plus/icons-vue'
//store管理
